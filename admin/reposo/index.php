...
<?php require '../../sql/inactivos/Reposo.php'; ?>
<?php require '../../sql/inactivos/Funciones.php'; ?>
<?php require '../../templates/admin/antetitulo.php'; ?>
<title>Personal de reposo - Policia Municipal</title>
<?php require '../../templates/admin/header.php'; ?>
<h2><span class="icon-health"></span>Ver personal en periodo de reposo</h2>
<div class="form-content">
    <?php if ($total == 0)
    {
        $mensaje = "No hay personal en periodo de reposo.";
    ?>
    ...
    ?>
        ...
        <table>
            <tr>
                ...
                <td>
                    <input type="hidden" name="motivo" value="reposo">
