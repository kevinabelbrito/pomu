...
<?php require '../../sql/pasantes/Lista.php'; ?>
<?php require '../../templates/admin/antetitulo.php'; ?>
<title>Pasantes - Policia Municipal</title>
<?php require '../../templates/admin/header.php'; ?>
<h2><span class="icon-clipboard2"></span>Pasantes</h2>
<div class="form-content">
	<?php if ($total == 0)
	{
		?>
		<strong>No hay pasantes registrados en el sistema.</strong>
		<?php
	}
	else
	{
	...
	<table border="1px">
		...
		<tr>
			...
			<td>
				desde:<?php echo $fila['desde']; ?>
				<br>
				hasta:<?php echo $fila['hasta']; ?>
			</td>
			<td>
				<div class="buttons">
